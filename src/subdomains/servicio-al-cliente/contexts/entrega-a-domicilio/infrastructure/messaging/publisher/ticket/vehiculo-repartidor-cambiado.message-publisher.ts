...
import { VehiculoRepartidorCambiadoEventPublisherBase } from '../../../../domain/events/publishers/ticket';
import { RepartidorEntity } from '../../../persistence/entities';


@Injectable()
export class VehiculoRepartidorCambiadoPublisher extends VehiculoRepartidorCambiadoEventPublisherBase {
