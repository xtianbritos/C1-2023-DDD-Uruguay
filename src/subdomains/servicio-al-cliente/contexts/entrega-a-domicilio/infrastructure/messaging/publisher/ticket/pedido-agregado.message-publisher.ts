...
import { PedidoAgregadoEventPublisherBase } from '../../../../domain/events/publishers/ticket';
import { PedidoEntity } from '../../../persistence/entities';


@Injectable()
export class PedidoAgregadoPublisher extends PedidoAgregadoEventPublisherBase {
