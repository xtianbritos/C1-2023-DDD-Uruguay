...
import { DireccionClienteCambiadaEventPublisherBase } from '../../../../domain/events/publishers/ticket';
import { ClienteEntity } from '../../../persistence/entities';


@Injectable()
export class DireccionClienteCambiadaPublisher extends DireccionClienteCambiadaEventPublisherBase {
